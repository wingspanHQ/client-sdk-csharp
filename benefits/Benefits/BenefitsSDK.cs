...
namespace Benefits
{
    ...
    public interface IBenefitsSDK
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetBenefitsEnrollmentIdResponse> GetBenefitsEnrollmentIdAsync(GetBenefitsEnrollmentIdRequest? request = null);
        ...
        /// </summary>
        Task<GetBenefitsPlanEnrollmentIdResponse> GetBenefitsPlanEnrollmentIdAsync(GetBenefitsPlanEnrollmentIdRequest? request = null);
        ...
        /// </remarks>
        /// </summary>
        Task<PatchBenefitsServiceIdResponse> PatchBenefitsServiceIdAsync(PatchBenefitsServiceIdRequest? request = null);
    }
    ...
    /// Wingspan Benefits API: Benefits
    /// </summary>
    public class BenefitsSDK: IBenefitsSDK
    {
        ...
        private const string _userAgent = "speakeasy-sdk/csharp 2.0.0 2.169.3 1.0.0 @wingspan/benefits";
        private string _serverUrl = "";
        private ISpeakeasyHttpClient _defaultClient;
        private ISpeakeasyHttpClient _securityClient;

        public BenefitsSDK(string? serverUrl = null, ISpeakeasyHttpClient? client = null)
        {
            _serverUrl = serverUrl ?? BenefitsSDK.ServerList[0];
        ...
        public async Task<GetBenefitsEnrollmentIdResponse> GetBenefitsEnrollmentIdAsync(GetBenefitsEnrollmentIdRequest? request = null)
        {
        ...
        public async Task<GetBenefitsPlanEnrollmentIdResponse> GetBenefitsPlanEnrollmentIdAsync(GetBenefitsPlanEnrollmentIdRequest? request = null)
        {
            string baseUrl = _serverUrl;
            if (baseUrl.EndsWith("/"))
            {
        ...
        public async Task<PatchBenefitsServiceIdResponse> PatchBenefitsServiceIdAsync(PatchBenefitsServiceIdRequest? request = null)
        {
            string baseUrl = _serverUrl;
            if (baseUrl.EndsWith("/"))
            {
